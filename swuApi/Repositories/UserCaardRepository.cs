...
namespace swuApi.Repositories
{
    public class UserCardRepository : IUserCardRepository
    {
        ...
        public Task<List<UserCard>> GetAllAsync()
        {
        ...
        {
            string query = @"
                INSERT INTO UserCards (UserId, CardId, Copies, DateAdded, IsFavorite) OUTPUT INSERTED.Id VALUES (@UserId, @CardId, @Copies, @DateAdded, @IsFavorite)";
        ...
        {
            string query = @"
                UPDATE UserCards SET Copies=@Copies, DateAdded=@DateAdded, IsFavorite=@IsFavorite WHERE Id=@Id";
        ...
        public Task<List<UserCard>> GetFilteredAsync(string? filterField, string? filterValue, string? sortField, string? sortDirection)
        {
            throw new NotImplementedException();
        }
        
        // Registro por claves compuestas
        ...
        // Añado copias o se actualiza la entrada
        ...
        // Saco todo el inventario de un usuario
